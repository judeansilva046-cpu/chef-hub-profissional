...
import type { CotacaoItemFormState } from "../types";

export interface CotacaoItemRowProps {
  item: CotacaoItemFormState;
  ingredientes: IngredienteParaSelecao[];
  onChange: (item: CotacaoItemFormState) => void;
  onRemove: () => void;
  podeRemover: boolean;
}

export function CotacaoItemRow({
  item,
  ingredientes,
  onChange,
  onRemove,
