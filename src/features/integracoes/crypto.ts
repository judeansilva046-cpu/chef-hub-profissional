 ...
 * + "." + base64(ciphertext). AAD (`empresaId:provedor`) amarra o ciphertext
 * ao contexto; ciphertext legado (sem AAD) ainda é aceito na descriptografia.
 */
...
export function descriptografarCredenciais(
  ...
  try {
    ...
    // Ciphertext legado (antes do AAD) — tenta uma vez sem AAD.
