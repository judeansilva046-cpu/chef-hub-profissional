-- Bundle gerado para colar no SQL Editor do Supabase.
-- Aplique SOMENTE se as migrations 0039 já estiverem no banco e 0040–0042 ainda não.
-- Fonte: supabase/migrations/0040 + 0041 + 0042

-- ========== 0040_security_hardening_operacional.sql ==========
...
-- ========== 0041_realtime_pedido_itens.sql ==========
